...
public class uploadAudio {
    ...
    private final String APP_KEY = "aXRc8GDFO7G3QHI3jn3Z0eeeizu0f4vK";

    // 填写网页上申请的APP SECRET 如 $SECRET_KEY="94dc99566550d87f8fa8ece112xxxxx"
    private final String SECRET_KEY = "2BY9xaCS0I1uOh1y2AYdFbsZx9RelcGa";
    ...
    public uploadAudio(String filename){
    ...
    public String runJsonPostMethod(String token) throws DemoException, IOException, JSONException {
    ...
    private String base64Encode(byte[] content) {
        ...
        char[] chars = Base64.encode(content); // 1.7 及以下，不推荐，请自行跟换相关库
